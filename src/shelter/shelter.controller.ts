...
export class ShelterController {
    ...
    async updateShelterDetails(@Body() input: UpdateShelterControllerInput):
        ...
        const useCaseInput = new UpdateShelterDetailsUseCaseInput({ ...input });   //estes ... é pq os nomes dos campos do objeto são iguais. se fossem diferentes teria que mapear na mão com CampoDestino = campoOrigem 
